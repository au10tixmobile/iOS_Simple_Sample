...
#ifndef AU10TIXUICOMPONENTPOA_SWIFT_H
#define AU10TIXUICOMPONENTPOA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Au10tixUIComponentPOA",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface Au10xPOAViewController (SWIFT_EXTENSION(Au10tixUIComponentPOA)) <Au10tixSessionDelegate>
