...
@property (nonatomic, strong) CIImage * _Nonnull ciImage;
...
- (nullable instancetype)initWithImageBuffer:(CVImageBufferRef _Nonnull)imageBuffer OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithData:(NSData * _Nonnull)data OBJC_DESIGNATED_INITIALIZER;
- (UIImage * _Nullable)resizedImageTo:(CGSize)size SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)resizedImageIn:(NSInteger)scale SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
