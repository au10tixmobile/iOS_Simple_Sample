...
SWIFT_CLASS("_TtC11Au10tixCore11Au10tixCore")
@interface Au10tixCore : NSObject
...
///
- (void)prepareWith:(NSString * _Nonnull)jwt completion:(void (^ _Nonnull)(NSString * _Nonnull, NSError * _Nullable))completion;
- (void)stopSession;
