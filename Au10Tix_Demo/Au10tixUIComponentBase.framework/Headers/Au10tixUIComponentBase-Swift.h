...
#ifndef AU10TIXUICOMPONENTBASE_SWIFT_H
#define AU10TIXUICOMPONENTBASE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Au10tixUIComponentBase",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22Au10tixUIComponentBase29UIComponentBaseViewController")
...
@interface UIComponentBaseViewController (SWIFT_EXTENSION(Au10tixUIComponentBase)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC22Au10tixUIComponentBase18UICompsButtonsView")
