...
#ifndef AU10SMARTDOCUMENTCAPTUREFEATURE_SWIFT_H
#define AU10SMARTDOCUMENTCAPTUREFEATURE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Au10SmartDocumentCaptureFeature",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC31Au10SmartDocumentCaptureFeature30Au10SmartDocumentSessionUpdate")
...
- (nonnull instancetype)initWithIsSmart:(BOOL)isSmart OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC31Au10SmartDocumentCaptureFeature19SmartDocumentResult")
