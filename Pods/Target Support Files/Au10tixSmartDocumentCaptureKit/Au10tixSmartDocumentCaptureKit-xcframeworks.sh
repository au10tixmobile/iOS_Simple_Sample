...
install_xcframework "${PODS_ROOT}/Au10tixSmartDocumentCaptureKit/Au10tixSmartDocumentCaptureKit.xcframework" "Au10tixSmartDocumentCaptureKit" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
