...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Au10tixBaseUI/Au10tixBaseUI.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Au10tixCore/Au10tixCore.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Au10tixPayCardKit/Au10tixPayCardKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Au10tixPayCardUI/Au10tixPayCardUI.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Au10tixProofOfAddressKit/Au10tixProofOfAddressKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Au10tixProofOfAddressUI/Au10tixProofOfAddressUI.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Au10tixSecureMeKit/Au10tixSecureMeKit.framework"
