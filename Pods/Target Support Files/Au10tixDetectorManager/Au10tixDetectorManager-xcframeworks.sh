...
install_xcframework "${PODS_ROOT}/Au10tixDetectorManager/Au10tixDetectorManager.xcframework" "Au10tixDetectorManager" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
