...
#ifndef AU10TIXBASEUI_SWIFT_H
#define AU10TIXBASEUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Au10tixBaseUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Au10tixBaseUI18DynamicUIImageView")
@interface DynamicUIImageView : UIImageView
- (void)drawRect:(CGRect)rect;
- (void)traitCollectionDidChange:(UITraitCollection * _Nullable)previousTraitCollection;
