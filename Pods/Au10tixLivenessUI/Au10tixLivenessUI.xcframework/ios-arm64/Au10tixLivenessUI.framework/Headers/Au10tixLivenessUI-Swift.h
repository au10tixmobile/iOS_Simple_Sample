...
#ifndef AU10TIXLIVENESSUI_SWIFT_H
#define AU10TIXLIVENESSUI_SWIFT_H
...
SWIFT_RESILIENT_CLASS_NAMED("LivenessViewController")
@interface Au10xLivenessViewController : UIComponentBaseViewController
- (void)viewDidLoad;
